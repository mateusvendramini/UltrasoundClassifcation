...
# Intervalo de altura a estimar: maior que 55 e menor que 95
MIN_HEIGHT = 55.0
MAX_HEIGHT = 95.0
...
# Para cada altura no experimental dentro do intervalo, encontrar altura e k mais próximos nos artificiais
for h_exp in experimental_data:
    if not (MIN_HEIGHT < h_exp < MAX_HEIGHT):
        continue
